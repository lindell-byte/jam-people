          ...
          {(Object.values(formData).some(value => value) || roles.some(role => role.role)) && (
            <div className="mt-8 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="text-sm text-gray-600 space-y-1">
                ...
                {formData.contactPerson && <p><strong>Contact Person:</strong> {formData.contactPerson}</p>}
                {formData.clientContactNo && <p><strong>Client Contact:</strong> {formData.clientContactNo}</p>}
